...
public class Method {
    ...
    public void add() {
        ...
        ProgrammingBook java2 = new ProgrammingBook(2, "hoclaptrinh2", 30000, "tu2", "java", "SonMC2");
        programmingBooks[1] = java2;
        ProgrammingBook java3 = new ProgrammingBook(3, "hoclaptrinh3", 20000, "tu3", "js", "SonMC3");
        programmingBooks[2] = java3;
        ProgrammingBook java4 = new ProgrammingBook(4, "hoclaptrinh4", 50000, "tu4", "C++", "SonMC4");
        programmingBooks[3] = java4;
        ProgrammingBook java5 = new ProgrammingBook(5, "hoclaptrinh5", 40000, "tu5", "Java", "SonMC5");
        programmingBooks[4] = java5;


        FictionBook b1 = new FictionBook(6, "sachvientuong1", 25000, "KieuAnh1", "A");
        fictionBooks[0] = b1;
        FictionBook b2 = new FictionBook(7, "sachvientuong2", 35000, "KieuAnh2", "B");
        fictionBooks[1] = b2;
        FictionBook b3 = new FictionBook(8, "sachvientuong3", 15000, "KieuAnh3", "C");
        fictionBooks[2] = b3;
        FictionBook b4 = new FictionBook(9, "sachvientuong4", 55000, "KieuAnh4", "D");
        fictionBooks[3] = b4;
        FictionBook b5 = new FictionBook(10, "sachvientuong5", 45000, "KieuAnh5", "E");
        fictionBooks[4] = b5;
